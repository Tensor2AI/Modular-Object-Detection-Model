...
class CyberWindow(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Modular Detection")
        ...
        title = QtWidgets.QLabel("MODULAR\nDETECTION")
        ...
        self.btn_start = self._neon_button("Live Feed", "#1F2A4A", "#1F2A4A")
        self.btn_stop = self._neon_button("Live Feed", "#1F2A4A", "#1F2A4A")
        self.btn_video = self._neon_button("Detect From Video", "#1F2A4A", "#1F2A4A")
        self.btn_image = self._neon_button("Detect From Image", "#1F2A4A", "#1F2A4A")
        ...
        self.btn_reset_target = self._neon_button("Reset Target", "#1F2A4A", "#1F2A4A", small=True)
        side_layout.addWidget(self.btn_reset_target)

        side_layout.addSpacing(6)

        # feature toggles
        self.btn_heatmap = self._neon_button("Show Heatmap", "#1F2A4A", "#1F2A4A")
        self.btn_toggle_roi = self._neon_button("Toggle ROI", "#1F2A4A", "#1F2A4A", small=True)
        side_layout.addWidget(self.btn_heatmap)
        side_layout.addWidget(self.btn_toggle_roi)

        side_layout.addStretch()

        self.btn_close = self._neon_button("Exit", "#1F2A4A", "#1F2A4A")
        ...
        self.btn_reset = self._neon_button("Reset Tracker", "#1F2A4A", "#1F2A4A", small=True)
        self.btn_show_counts = self._neon_button("Reset Counts", "#1F2A4A", "#1F2A4A", small=True)
    ...
    # ----- UI helpers -----
    def _neon_button(self, text, color_a="#1F2A4A", color_b="#1F2A4A", small=False):
